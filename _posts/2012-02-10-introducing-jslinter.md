...
Because JSLinter was only a simple addon, I decided to create it using Mozilla's [Addon SDK](https://addons.mozilla.org/developers/builder), which made it's development quite pleasant and resulted in a bunch of free features (restartless, compatibility with future Firefox releases, etc).
...
JSLinter is available for download at [addons.mozilla.org](https://addons.mozilla.org/addon/jslinter?src=external-rolandwarmerdam.co.nz) and it's source code is available at [Github](https://github.com/Rowno/jslinter) (pull requests are welcome). I hope you find it useful! :)
